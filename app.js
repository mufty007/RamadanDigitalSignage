...
//     setInterval(changeTileBackground, 1000);
...
//     let startRedIndex = currentDate.getDate() - 1;

//     if (startRedIndex >= tiles.length) {
//       startRedIndex = 0;
//     }

//     for (let i = 0; i < tiles.length; i++) {
//         const tileDataId = parseInt(tiles[i].getAttribute('data-id'));
//         if (tileDataId === startRedIndex) {
//           tiles[i].classList.add('red-bg');
//         } else {
//           tiles[i].classList.remove('red-bg');
//         }
//       }
//   }
